...
//  Purpose:
//
//    MAIN is the main program for FREEFEM++_MSH_IO_TEST.
//
//  Discussion:
//
//    FREEFEM++_MSH_IO_TEST tests the FREEFEM++_MSH_IO library.
//
//  Licensing:
//
