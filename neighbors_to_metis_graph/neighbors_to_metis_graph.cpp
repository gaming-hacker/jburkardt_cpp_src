...
void metis_graph_write ( string output_file_name, int m, int n, int neighbor[] );
...
{ 
  ...
  int element_num;
  int element_faces;
  string input_neighbor_file_name;
  string output_metis_graph_file_name;
...
//
  if ( 1 < argc )
  {
    input_neighbor_file_name = argv[1];
  }
  else
  {
    cout << "\n";
...
//
  output_metis_graph_file_name = filename_ext_swap ( input_neighbor_file_name, 
    "metis_graph" );
