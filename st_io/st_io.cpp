...
void r8st_data_read ( string input_filename, int m, int n, int nst, 
...
//
{
  ...
  for ( k = 0; k < nst; k++ )
  {
    ...
    {
      cerr << "\n";
      cerr <<"R8ST_DATA_READ - Fatal error!\n";
...
void r8st_header_read ( string input_filename, int &i_min, int &i_max, 
...
void r8st_write ( string output_filename, int m, int n, int nst, int ist[], 
  int jst[], double ast[] )
