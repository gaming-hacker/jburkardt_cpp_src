...
void gmsh_write ( string gmsh_filename, int dim_num, int node_num, 
...
void tet_mesh_base_one ( int node_num, int element_order, int element_num,
  int element_node[] );
void timestamp ( );
...
//
{
  ...
  timestamp ( );
  cout << "\n";
  cout << "TET_MESH_TO_GMSH;\n";
  cout << "  C++ version\n";
  cout << "  Convert a linear or quadratic tet mesh to Gmsh format\n";
  cout << "\n";
  cout << "  Read \"prefix\"_nodes.txt, node coordinates.\n";
  cout << "  Read \"prefix\"_elements.txt, 4 or 10 node element definitions.\n";
  cout << "\n";
...
//
  ...
  {
    cout << "\n";
    cout << "TET_MESH_TO_GMSH; - Fatal error!\n";
...
//
  ...
  else
  {
    cout << "\n";
    cout << "TET_MESH_TO_GMSH; - Fatal error!\n";
    cout << "  The tet mesh must have order 4, 10, or 20.\n";
    exit ( 1 );
  }
...
//
  tet_mesh_base_one ( node_num, element_order, element_num, element_node );
//
//  Write the Gmsh file.
//
  gmsh_write ( gmsh_filename, dim_num, node_num, node_xyz, element_order,
    element_num, element_node );

  cout << "\n";
  cout << "  Created GMSH file \"" << gmsh_filename << "\".\n";
//
//  Free memory.
//
  delete [] node_xyz;
...
//
{
  ...
  {
    cout << "\n";
    cout << "TET_MESH_BASE_ONE - Warning!\n";
