...
void tet_mesh_base_zero ( int node_num, int element_order, int element_num,
  int element_node[] );
void timestamp ( );
void xml_write ( string xml_filename, int dim_num, int node_num, 
...
//
{
  ...
  timestamp ( );
  cout << "\n";
  cout << "TET_MESH_TO_XML;\n";
  cout << "  C++ version\n";
  cout << "  Convert a tet mesh to DOLFIN XML format\n";
  cout << "\n";
  cout << "  Read \"prefix\"_nodes.txt, node coordinates.\n";
  cout << "  Read \"prefix\"_elements.txt, 4, 10 or 20 node element definitions.\n";
  cout << "\n";
  cout << "  Create \"prefix\".xml, a corresponding DOLFIN XML mesh file.\n";
  cout << "\n";
...
//
  ...
  {
    cout << "\n";
    cout << "TET_MESH_TO_XML; - Fatal error!\n";
...
//
  xml_write ( xml_filename, dim_num, node_num, node_xyz, element_order,
...
//
  ...
  xml << "  <mesh celltype=\"tetrahedron\" dim=\"3\">\n";
