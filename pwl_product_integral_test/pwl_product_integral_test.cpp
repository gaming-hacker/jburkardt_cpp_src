...
# include "pwl_product_integral.hpp"
...
//
{
  timestamp ( );
  cout << "\n";
  cout << "pwl_PRODUCT_INTEGRAL_TEST\n";
  cout << "  C++ version\n";
  cout << "  Test the pwl_PRODUCT_INTEGRAL_INTEGRAL library.\n";
...
# define G_NUM 2
  ...
  cout << "\n";
  cout << "TEST01\n";
  cout << "  Test pwl_PRODUCT_INTEGRAL on a very simple problem.\n";
  ...
  {
    b = ( double ) ( i );
    integral = pwl_product_integral ( a, b, f_num, f_x, f_v, g_num, 
      g_x, g_v );
...
# define G_NUM 4
  ...
  cout << "\n";
  cout << "TEST02\n";
  cout << "  Test pwl_PRODUCT_INTEGRAL on a simple problem.\n";
...
# define G_NUM 31
  ...
  {
    b = ( double ) ( i ) * pi / 6.0;
    integral = pwl_product_integral ( a, b, f_num, f_x, f_v, 
      g_num, g_x, g_v );
    exact = - ( cos ( 2.0 * b ) - cos ( 2.0 * a ) ) / 2.0;
    quad_num = 2000;
    quad = pwl_product_quad ( a, b, f_num, f_x, f_v, g_num, 
      g_x, g_v, quad_num );
    cout << "  " << setw(10) << a
         << "  " << setw(10) << b
         << "  " << setw(14) << integral
...
# define G_NUM 3
  ...
  cout << "\n";
  cout << "TEST04\n";
  cout << "  Test pwl_PRODUCT_INTEGRAL.\n";
  ...
  integral = pwl_product_integral ( a, b, f_num, f_x, f_v, f_num, 
    f_x, f_v );
  ...
  integral = pwl_product_integral ( a, b, g_num, g_x, g_v, g_num, 
    g_x, g_v );
