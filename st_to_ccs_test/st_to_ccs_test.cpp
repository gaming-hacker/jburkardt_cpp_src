...
# define NST 12
  ...
  cout << "\n";
  cout << "TEST01\n";
  cout << "  Convert a sparse matrix from ST to CCS format.\n";
  cout << "  ST:  sparse triplet,    I, J,  A.\n";
  cout << "  CCS: compressed column, I, CC, A.\n";
...
//
  ...
  st_to_ccs_index ( nst, ist, jst, ncc, n, icc, ccc );
//
//  Create the CCS values.
//
  acc = st_to_ccs_values ( nst, ist, jst, ast, ncc, n, icc, ccc );
//
//  Print the CCS matrix.
//
  ccs_print ( m, n, ncc, icc, ccc, acc, "  CCS Matrix:" );
//
//  Free memory.
//
  delete [] acc;
...
//
{
  ...
  cout << "  and the CCS matrix is written to the files:\n";
  cout << "    '" << filename_icc << "',\n";
