...
//
{
  ...
  cout << "\n";
  cout << "tribonacci_direct_test():\n";
  cout << "  tribonacci_direct() computes the Tribonacci sequence.\n";
  cout << "\n";
...
//
{
  ...
  cout << "\n";
  cout << "tribonacci_roots_test():\n";
  cout << "  tribonacci_roots() computes the Tribonacci roots.\n";
  cout << "\n";
  ...
  pc = pow ( beta, 3 ) - pow ( beta, 2 ) - beta - 1.0;
  cout << "  beta = " << beta
       << ", p(beta) = " << pc << "\n";

  pc = pow ( gamma, 3 ) - pow ( gamma, 2 ) - gamma - 1.0;
  cout << "  gamma = " << gamma
       << ", p(gamma) = " << pc << "\n";
