...
//
{
  ...
  timestamp ( );
  cout << "\n";
  cout << "midpoint_fixed_test:\n";
  cout << "  C++ version\n";
  cout << "  Test midpoint_fixed() on several ODE's.\n";
...
//
{
  ...
  cout << "\n";
  cout << "predator_prey_midpoint_fixed_test\n";
...
//
  ...
  cout << "\n";
  cout << "  predator_prey_midpoint_fixed_test: data stored in '" << data_filename << "'.\n";
//
...
//
  ...
  command << "set title 'Predator prey: midpoint fixed'\n";
  command << "set grid\n";
  ...
  cout << "  predator_prey_midpoint_fixed_test: plot commands stored in '" << command_filename << "'.\n";
...
//
{
  ...
  cout << "\n";
  cout << "stiff_midpoint_fixed_test\n";
  cout << "  Solve stiff ODE using midpoint_fixed().\n";
