...
string ymd_to_s_julian ( int y, int m, int d )
...
string ymdf_to_s_julian ( int y, int m, int d, double f )
...
//
{
  ...
  if ( 0 <= y )
  {
    sprintf ( s_char, "AD %d/%02d/%02d%.2f", y, m, d, f );
  }
  else
  {
    sprintf ( s_char, "BC %d/%02d/%02d%.2f", -y, m, d, f );
  }
