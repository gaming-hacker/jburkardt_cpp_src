void ccs_data_read ( string prefix, int ncc, int n, int icc[], int ccc[], 
  double acc[] );
void ccs_header_read ( string prefix, int &ncc, int &n );
void ccs_print ( int m, int n, int ncc, int icc[], int ccc[], double acc[], 
  string title );
void ccs_print_some ( int i_min, int i_max, int j_min, int j_max, int ncc, 
  int n, int icc[], int ccc[], double acc[], string title );
void ccs_write ( string prefix, int ncc, int n, int icc[], int ccc[], 
  double acc[] );
