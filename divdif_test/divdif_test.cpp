...
//
{
  ...
  cout << "\n";
  cout << "dif_derivk_table_test\n";
  cout << "  dif_derivk_table() computes the K-th derivative\n";
  cout << "  for a divided difference table.\n";
//
