...
//  Purpose:
//
//    r8st_CG uses the conjugate gradient method on an r8st linear system.
//
//  Discussion:
//
...
//
//    Output, bool r8st_CHECK, is TRUE if the matrix is properly defined.
//
{
  bool check;
  int k;
...
//
//    Output, double r8st_DIF2[NZ_NUM], the matrix.
//
{
  double *a;
  int i;
...
//    matrix entry.
//
//    Output, int r8st_IJ_TO_K, the r8st index of the (I,J) entry.
//
{
  int hi;
  int k;
...
//    of the nonzero elements.
//
//    Output, double r8st_INDICATOR[NZ_NUM], the nonzero elements of the matrix.
//
{
  double *a;
  int fac;
...
void r8st_jac_sl ( int n, int nz_num, int row[], int col[], double a[], 
...
//
{
  ...
  r8st_diagonal ( n, n, nz_num, row, col, a );
...
//  Purpose:
//
//    r8st_MTV multiplies a vector times an r8st matrix.
//
//  Discussion:
//
//    The r8st storage format stores the row, column and value of each nonzero
...
//  Purpose:
//
//    r8st_MV multiplies an r8st matrix times a vector.
//
//  Discussion:
//
//    The r8st storage format stores the row, column and value of each nonzero
...
//
//    Output, double r8st_MV[M], the product vector A*X.
//
{
  double *b;
  int i;
...
//
//    Output, double r8st_RANDOM[NZ_NUM], the nonzero elements of the matrix.
//
{
  double *r;
...
//
//    Output, double r8st_RES[M], the residual R = B - A * X.
//
{
  int i;
  double *r;
...
//  Purpose:
//
//    r8st_ZEROS returns a zero r8st matrix.
//
//  Discussion:
//
//    The r8st storage format stores the row, column and value of each nonzero
//    entry of a sparse matrix.
//
//    The r8st format is used by SLAP (nonsymmetric case), by MATLAB,
...
//    of the nonzero elements.
//
//    Output, double r8st_ZERO[NZ_NUM], the (potentially) nonzero elements 
//    of the matrix.
//
{
  double *a;
