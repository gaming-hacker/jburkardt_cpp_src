...
void tet_mesh_base_zero ( int element_order, int element_num, 
  int element_node[] );
...
//
  tet_mesh_base_zero ( element_order, element_num, element_node );
//
...
//
  node_min = element_node[0+0*element_order];
  node_max = -1;
