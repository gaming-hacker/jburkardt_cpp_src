...
//
{
  ...
  cout << "\n";
  cout << "I4_BINOMIAL_SAMPLE_TEST\n";
  cout << "  I4_BINOMIAL_SAMPLE samples the binomial distribution.\n";
  cout << "\n";
  cout << "   N         P   K        PDF\n";
  cout << "\n";
...
//
{
  ...
  cout << "\n";
  cout << "I4_UNIFORM_SAMPLE_TEST\n";
  cout << "  I4_UNIFORM_SAMPLE samples the uniform distribution on integers.\n";
  cout << "  Generate integer C between limits A and B.\n";
  cout << "\n";
  cout << "    A    B   C\n";
  cout << "\n";
