  ...
  for ( point = 0; point < point_num; point++ )
  {
    ...
    for ( dim = 0; dim < dim_num; dim++ )
    {
      value[point] = value[point] 
        * 2.0 * fabs ( 2.0 * x[dim+point*dim_num] - 1.0 );
    }
  }
...
//
{
  ...
  for ( point = 0; point < point_num; point++ )
  {
    ...
    for ( dim = 0; dim < dim_num; dim++ )
    {
      value[point] = value[point] + fabs ( x[dim+point*dim_num] - 0.5 );
    }
  }
...
//
{
  ...
  for ( point = 0; point < point_num; point++ )
  {
    ...
    {
      value[point] = value[point] 
        + fabs ( 2.0 * x[dim+point*dim_num] - 1.0 );
    }
...
//
{
  ...
  for ( point = 0; point < point_num; point++ )
  {
    ...
    for ( dim = 0; dim < dim_num; dim++ )
    {
      value[point] = value[point] + fabs ( x[dim+point*dim_num] - z[dim] );
    }
  }
...
//
{
  ...
  for ( point = 0; point < point_num; point++ )
  {
    ...
    {
      value[point] = value[point] 
        * sqrt ( fabs ( x[dim+point*dim_num] - z[dim] ) );
    }
  }
...
//
{
  ...
  for ( point = 0; point < point_num; point++ )
  {
    ...
    for ( dim = 0; dim < dim_num; dim++ )
    {
      value[point] = value[point] * ( fabs ( 4.0 
...
//
{
  ...
  for ( ; ; )
  {
    ...
    if ( fabs ( term2 ) <= roundoff * ( 1.0 + fabs ( exact ) ) )
    {
      break;
    }
    exact = exact + term2;
...
//
{
  ...
  for ( point = 0; point < point_num; point++ )
  {
    ...
    {
      value[point] = value[point] 
        - c[dim] * fabs ( x[dim+point*dim_num] - z[dim] );
    }
    value[point] = exp ( value[point] );
  }
